...
func TestEndpointSuccess(t *testing.T) {
	...
	svc.EXPECT().CreateTransaction(gomock.Any(), gomock.Any()).Return(nil)
...
func TestCreateEndpointError(t *testing.T) {
	...
	svc.EXPECT().CreateTransaction(gomock.Any(), gomock.Any()).Return(errors.New("error"))
...
func TestRequest(t *testing.T) {
	...
	require.Equal(req.Method(), "create_transaction")
}
